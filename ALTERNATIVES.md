...
> One final strategy variation - Instead of treating rates as a side leg on Brent-WTI, we could build a standalone cross-asset mean-reversion strategy on WTI (CL) and front-end rates (SR3):
>
