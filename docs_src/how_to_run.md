...
| `docs_src/` | Site pages and figures; every `.md` here becomes a page |
| `dataframe_docs/` | Per-dataframe reference text, inlined into the generated catalog pages |
| `chartbook_overlays/` | Patches applied to the installed `chartbook` package before a build |
